...
* I will plot class of passengers according to their age in years.
...
```
### Numerical data visualization for variable SibSp and Parch
* Over here the variable SibSp presents the Number of Siblings/Spouses Aboard and Parch represents the Number of Parents/Children Aboard.I will plot these variables and try to observe the finding.
```{r warning=FALSE, message=FALSE, echo= FALSE}
ggplot(titanic_train, aes(x = SibSp, y = Parch, color = Sex)) +
  geom_point(position = "jitter", alpha = 0.6) + facet_wrap(~Sex, nrow = 2) 
```
